...
public class Settings {
    ...
    public synchronized Settings initialize(Kit kit, IdManager idManager, HttpRequestFactory httpRequestFactory, String versionCode, String versionName, String urlEndpoint) {
        ...
        if (this.initialized) {
            ...
            if (this.settingsController == null) {
                ...
                SettingsSpiCall defaultSettingsSpiCall = new DefaultSettingsSpiCall(kit, urlEndpoint, String.format(Locale.US, "https://settings.crashlytics.com/spi/v2/platforms/android/apps/%s/settings", new Object[]{appIdentifier}), httpRequestFactory);
    ...
    public SettingsData awaitSettingsData() {
        try {
            ...
            Fabric.getLogger().m1455e("Fabric", "Interrupted while waiting for settings data.");
            return null;
        }
    }
    ...
    public synchronized boolean loadSettingsSkippingCache() {
        ...
        if (settingsData == null) {
            Fabric.getLogger().m1456e("Fabric", "Failed to force reload of settings from Crashlytics.", null);
        }
        return settingsData != null;
    }
