...
class DefaultCachedSettingsIo implements CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        Exception e;
        Throwable th;
        Fabric.getLogger().m1453d("Fabric", "Reading cached settings...");
        ...
        try {
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    ...
                    fis = fis2;
                    try {
                        Fabric.getLogger().m1456e("Fabric", "Failed to fetch cached settings", e);
            ...
            Fabric.getLogger().m1453d("Fabric", "No cached settings found.");
            CommonUtils.closeOrLog(fis, "Error while closing settings cache file.");
        } catch (Exception e3) {
            e = e3;
            Fabric.getLogger().m1456e("Fabric", "Failed to fetch cached settings", e);
    ...
    public void writeCachedSettings(long expiresAtMillis, JSONObject settingsJson) {
        Exception e;
        Throwable th;
        Fabric.getLogger().m1453d("Fabric", "Writing settings to cache file...");
        if (settingsJson != null) {
            ...
            try {
                ...
                try {
                    ...
                    writer = writer2;
                    try {
                        Fabric.getLogger().m1456e("Fabric", "Failed to cache settings", e);
