...
class PinningTrustManager implements X509TrustManager {
    ...
    private void checkPinTrust(X509Certificate[] chain) throws CertificateException {
        ...
        Fabric.getLogger().m1459w("Fabric", "Certificate pins are stale, (" + (System.currentTimeMillis() - this.pinCreationTimeMillis) + " millis vs " + 15552000000L + " millis) " + "falling back to system trust.");
    }
