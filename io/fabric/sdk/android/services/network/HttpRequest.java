...
public class HttpRequest {
    ...
    class C18288 extends CloseOperation<HttpRequest> {
        final /* synthetic */ InputStream val$input;
        final /* synthetic */ OutputStream val$output;

        C18288(Closeable x0, boolean x1, InputStream inputStream, OutputStream outputStream) {
    ...
    public interface ConnectionFactory {
        ...
        static class C18291 implements ConnectionFactory {
            C18291() {
            }
    ...
    protected HttpRequest copy(InputStream input, OutputStream output) throws IOException {
        return (HttpRequest) new C18288(input, this.ignoreCloseExceptions, input, output).call();
    }
