...
public abstract class AbstractSpiCall {
    ...
    protected HttpRequest getHttpRequest(Map<String, String> queryParams) {
        return this.requestFactory.buildHttpRequest(this.method, getUrl(), queryParams).useCaches(false).connectTimeout(PoiDetailFragment.MIN_STREET_VIEW_BYTES).header("User-Agent", "Crashlytics Android SDK/" + this.kit.getVersion()).header("X-CRASHLYTICS-DEVELOPER-TOKEN", "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
