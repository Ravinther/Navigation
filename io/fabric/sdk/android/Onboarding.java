...
class Onboarding extends Kit<Boolean> {
    ...
    protected boolean onPreExecute() {
        try {
            ...
            Fabric.getLogger().m1456e("Fabric", "Failed init", e);
            return false;
        }
    }
    ...
    protected Boolean doInBackground() {
        ...
        if (settingsData != null) {
            try {
                ...
                Fabric.getLogger().m1456e("Fabric", "Error performing auto configuration.", e);
            }
        }
    ...
    private SettingsData retrieveSettingsData() {
        try {
            ...
            Fabric.getLogger().m1456e("Fabric", "Error dealing with settings", e);
            return null;
        }
    }
    ...
    private boolean performAutoConfigure(String iconHash, AppSettingsData appSettings, Collection<KitInfo> sdkKits) {
        if ("new".equals(appSettings.status)) {
            ...
            Fabric.getLogger().m1456e("Fabric", "Failed to create app with Crashlytics service.", null);
            return false;
            ...
            Fabric.getLogger().m1453d("Fabric", "Server says an update is required - forcing a full App update.");
