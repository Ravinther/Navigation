...
public class RecentDashPlugin extends MemoDashPlugin {
    public static DashboardPlugin newInstance(WidgetItem widgetItem) {
        if (widgetItem == null) {
            widgetItem = new WidgetItem(EWidgetType.widgetTypeRecent, EWidgetSize.widgetSizeHalfRow);
        }
        return new RecentDashPlugin(widgetItem);
    }

    private RecentDashPlugin(WidgetItem widgetItem) {
        super(widgetItem);
    }
