...
public class CencEncryptingSampleList extends AbstractList<Sample> {
                        ...
                        if (pair.encrypted() > 0) {
                            ...
                            if ($assertionsDisabled || toBeEncrypted.length % 16 == 0) {
                                ...
                                if (!$assertionsDisabled) {
                                    ...
                                    int length2 = toBeEncrypted.length;
                                    if (length != r0) {
    ...
    public Sample get(int index) {
        ...
        if (this.ceks.get(Integer.valueOf(index)) != null) {
            return new EncryptedSampleImpl(clearSample, (CencSampleAuxiliaryDataFormat) this.auxiliaryDataFormats.get(index), this.cipher, (SecretKey) this.ceks.get(Integer.valueOf(index)), null);
        }
        return clearSample;
    }
