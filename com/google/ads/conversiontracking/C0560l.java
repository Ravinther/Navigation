...
import com.google.ads.conversiontracking.C0554h.C0553a;
...
public final class C0560l {
    ...
    public static int m1413a(Context context) {
        PackageManager packageManager = context.getPackageManager();
        try {
            context.getResources().getString(C0553a.f1212a);
        } catch (Throwable th) {
        ...
        C0560l.m1422c(context);
        try {
            PackageInfo packageInfo = packageManager.getPackageInfo("com.google.android.gms", 64);
            try {
                if (C0560l.m1417a(packageManager.getPackageInfo("com.android.vending", 64), f1218a) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (C0560l.m1417a(packageInfo, C0560l.m1417a(packageManager.getPackageInfo("com.android.vending", 64), f1218a)) == null) {
    ...
    public static Intent m1414a(Context context, int i, int i2) {
        switch (i) {
            case TTSConst.TTSMULTILINE /*1*/:
            case TTSConst.TTSPARAGRAPH /*2*/:
                return C0560l.m1416a(i2) ? C0560l.m1423d(context) ? C0562o.m1428c("com.google.android.gms") : C0562o.m1427b("com.google.android.apps.bazaar") : C0562o.m1427b("com.google.android.gms");
            case TTSConst.TTSUNICODE /*3*/:
                return C0562o.m1426a("com.google.android.gms");
            case TTSConst.TTSEVT_NOTSENT /*12*/:
                return C0562o.m1425a();
            default:
                return null;
        }
    }

    public static boolean m1415a() {
        return f1223f ? f1224g : "user".equals(Build.TYPE);
    }

    static boolean m1416a(int i) {
        switch (C0560l.m1420b(i)) {
            case TTSConst.TTSEVT_AUDIOSTART /*0*/:
                return !C0560l.m1415a();
            case TTSConst.TTSMULTILINE /*1*/:
                return true;
            case TTSConst.TTSPARAGRAPH /*2*/:
                return false;
    ...
    private static byte[] m1417a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[] m1418a(String str) {
        try {
    ...
    private static byte[][] m1419a(byte[][]... bArr) {
        int i = 0;
    ...
    private static int m1420b(int i) {
        return i == -1 ? 2 : i;
    }

    public static void m1421b(Context context) throws C0559k, C0557j {
        int a = C0560l.m1413a(context);
        if (a != 0) {
            Intent a2 = C0560l.m1414a(context, a, -1);
            Log.e("GooglePlayServicesUtil", "GooglePlayServices not available due to error " + a);
            if (a2 == null) {
                throw new C0557j(a);
            }
            throw new C0559k(a, "Google Play Services not available", a2);
        }
    }

    private static void m1422c(Context context) {
    ...
    private static boolean m1423d(Context context) {
        if (f1223f) {
            return f1225h;
        }
        try {
            return C0560l.m1417a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f1222e) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
