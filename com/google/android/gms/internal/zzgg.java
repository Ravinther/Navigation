...
public class zzgg implements zza<zzd> {
    ...
    public /* synthetic */ zzh.zza zza(zzgf com_google_android_gms_internal_zzgf, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        return zzb(com_google_android_gms_internal_zzgf, jSONObject);
    }

    public zzd zzb(zzgf com_google_android_gms_internal_zzgf, JSONObject jSONObject) throws JSONException, InterruptedException, ExecutionException {
        List<zzih> zza = com_google_android_gms_internal_zzgf.zza(jSONObject, "images", true, this.zzDl, this.zzDm);
        Future zza2 = com_google_android_gms_internal_zzgf.zza(jSONObject, "app_icon", true, this.zzDl);
