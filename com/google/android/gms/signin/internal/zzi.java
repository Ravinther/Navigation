...
public class zzi extends zzj<zzf> implements zzd {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzd.zza {
        ...
        class C09971 implements Runnable {
            ...
            C09971(zza com_google_android_gms_signin_internal_zzi_zza, List list, String str, zzf com_google_android_gms_signin_internal_zzf) {
        ...
        class C09982 implements Runnable {
            ...
            C09982(zza com_google_android_gms_signin_internal_zzi_zza, String str, String str2, zzf com_google_android_gms_signin_internal_zzf) {
                this.zzaOs = com_google_android_gms_signin_internal_zzi_zza;
                this.zzaOq = str;
                this.zzaOt = str2;
                this.zzaOr = com_google_android_gms_signin_internal_zzf;
        ...
        public void zza(String str, String str2, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaOo.submit(new C09982(this, str, str2, com_google_android_gms_signin_internal_zzf));
        }

        public void zza(String str, List<Scope> list, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaOo.submit(new C09971(this, list, str, com_google_android_gms_signin_internal_zzf));
        }
    }
