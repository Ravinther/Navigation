...
abstract class BitmapHunter implements Runnable {
    ...
    static class C10761 extends ThreadLocal<StringBuilder> {
        C10761() {
        }
    ...
    static class C10772 implements Runnable {
        final /* synthetic */ StringBuilder val$builder;

        C10772(StringBuilder stringBuilder) {
    ...
    static class C10783 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C10783(Transformation transformation) {
    ...
    static class C10794 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C10794(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    static Bitmap applyCustomTransformations(List<Transformation> transformations, Bitmap result) {
        ...
        while (i < count) {
            ...
            if (newResult == null) {
                ...
                Picasso.HANDLER.post(new C10772(builder));
                return null;
            } else if (newResult == result && result.isRecycled()) {
                Picasso.HANDLER.post(new C10783(transformation));
                return null;
            } else if (newResult == result || result.isRecycled()) {
                result = newResult;
                i++;
            } else {
                Picasso.HANDLER.post(new C10794(transformation));
                return null;
            }
        }
        return result;
