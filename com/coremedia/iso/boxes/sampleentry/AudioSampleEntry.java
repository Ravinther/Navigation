...
public final class AudioSampleEntry extends AbstractSampleEntry {
    ...
    public void parse(DataSource dataSource, ByteBuffer header, long contentSize, BoxParser boxParser) throws IOException {
        ...
        if ("owma".equals(this.type)) {
            ...
            long remaining = ((contentSize - 28) - ((long) (this.soundVersion == 1 ? 16 : 0))) - ((long) (this.soundVersion == 2 ? 36 : 0));
            ByteBuffer owmaSpecifics = ByteBuffer.allocate(CastUtils.l2i(remaining));
            dataSource.read(owmaSpecifics);
            addBox(new C02671(remaining, owmaSpecifics));
            return;
        }
