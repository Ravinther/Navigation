...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C00021 implements OnApplyWindowInsetsListener {
        C00021() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0001R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0001R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0001R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00021());
    }
