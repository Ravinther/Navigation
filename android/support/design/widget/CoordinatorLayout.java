...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00071 implements Comparator<View> {
        C00071() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.mAnchorId = -1;
            this.mLastChildRect = new Rect();
            TypedArray a = context.obtainStyledAttributes(attrs, C0001R.styleable.CoordinatorLayout_LayoutParams);
            this.gravity = a.getInteger(C0001R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0001R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0001R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0001R.styleable.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            this.mBehaviorResolved = a.hasValue(C0001R.styleable.CoordinatorLayout_LayoutParams_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0001R.styleable.CoordinatorLayout_LayoutParams_layout_behavior));
            }
            a.recycle();
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mLayoutDependencyComparator = new C00071();
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0001R.styleable.CoordinatorLayout, defStyleAttr, C0001R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0001R.styleable.CoordinatorLayout_keylines, 0);
