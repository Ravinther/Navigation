...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C00731 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00731() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00731());
        }
    ...
    static {
        ...
        COMPARATOR = new C00701();
        sInterpolator = new C00712();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00723();
        this.mScrollState = 0;
        initViewPager();
    }
    ...
    L_0x0095:
        r27 = r30.getResources();	 Catch:{ NotFoundException -> 0x0101 }
        r28 = r30.getId();	 Catch:{ NotFoundException -> 0x0101 }
        r24 = r27.getResourceName(r28);	 Catch:{ NotFoundException -> 0x0101 }
    L_0x00a1:
