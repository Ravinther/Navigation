...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, ActionMenuChildView, OnClickListener, OnLongClickListener {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mAllowTextWithIcon = res.getBoolean(C0101R.bool.abc_config_allowActionMenuItemTextWithIcon);
        TypedArray a = context.obtainStyledAttributes(attrs, C0101R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0101R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        this.mAllowTextWithIcon = getContext().getResources().getBoolean(C0101R.bool.abc_config_allowActionMenuItemTextWithIcon);
