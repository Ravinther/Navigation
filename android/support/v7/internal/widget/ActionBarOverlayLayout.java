...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    class C01101 extends ViewPropertyAnimatorListenerAdapter {
        C01101() {
        }
    ...
    class C01112 extends ViewPropertyAnimatorListenerAdapter {
        C01112() {
        }
    ...
    class C01134 implements Runnable {
        C01134() {
        }
    ...
    static {
        ATTRS = new int[]{C0101R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01101();
        this.mBottomAnimatorListener = new C01112();
        this.mRemoveActionBarHideOffset = new C01123();
        this.mAddActionBarHideOffset = new C01134();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0101R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0101R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0101R.id.action_bar));
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0101R.id.split_action_bar);
        }
    }
