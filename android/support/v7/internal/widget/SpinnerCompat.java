...
class SpinnerCompat extends AbsSpinnerCompat implements OnClickListener {
    ...
    class C01221 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C01221(View x0, DropdownPopup dropdownPopup) {
    ...
    class C01232 implements OnGlobalLayoutListener {
        C01232() {
        }
    ...
    private class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        class C01241 implements OnItemClickListener {
            final /* synthetic */ SpinnerCompat val$this$0;

            C01241(SpinnerCompat spinnerCompat) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setModal(true);
            setPromptPosition(0);
            setOnItemClickListener(new C01241(SpinnerCompat.this));
        }
    ...
    SpinnerCompat(Context context, AttributeSet attrs, int defStyle, int mode) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0101R.styleable.Spinner, defStyle, 0);
        if (a.hasValue(C0101R.styleable.Spinner_android_background)) {
            setBackgroundDrawable(a.getDrawable(C0101R.styleable.Spinner_android_background));
        }
        if (mode == -1) {
            mode = a.getInt(C0101R.styleable.Spinner_spinnerMode, 0);
        }
        switch (mode) {
            ...
            case TTSConst.TTSMULTILINE /*1*/:
                ...
                this.mDropDownWidth = a.getLayoutDimension(C0101R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(a.getDrawable(C0101R.styleable.Spinner_android_popupBackground));
                this.mPopup = popup;
                this.mForwardingListener = new C01221(this, popup);
                break;
        }
        this.mGravity = a.getInt(C0101R.styleable.Spinner_android_gravity, 17);
        this.mPopup.setPromptText(a.getString(C0101R.styleable.Spinner_prompt));
        this.mDisableChildrenWhenDisabled = a.getBoolean(C0101R.styleable.Spinner_disableChildrenWhenDisabled, false);
        a.recycle();
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.showDropdown) {
            ...
            if (vto != null) {
                vto.addOnGlobalLayoutListener(new C01232());
            }
        }
    }
}
