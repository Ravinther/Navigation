...
public class ActionBarContextView extends AbsActionBarView implements ViewPropertyAnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0101R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0101R.styleable.ActionMode, defStyle, 0);
        setBackgroundDrawable(a.getDrawable(C0101R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0101R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0101R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0101R.styleable.ActionMode_height, 0);
        this.mSplitBackground = a.getDrawable(C0101R.styleable.ActionMode_backgroundSplit);
        this.mCloseItemLayout = a.getResourceId(C0101R.styleable.ActionMode_closeItemLayout, C0101R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        ...
        int i2 = 8;
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0101R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0101R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0101R.id.action_bar_subtitle);
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(C0101R.id.action_mode_close_button).setOnClickListener(new C01091(mode));
