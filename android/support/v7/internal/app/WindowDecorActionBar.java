...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C01031 extends ViewPropertyAnimatorListenerAdapter {
        C01031() {
        }
    ...
    class C01042 extends ViewPropertyAnimatorListenerAdapter {
        C01042() {
        }
    ...
    class C01053 implements ViewPropertyAnimatorUpdateListener {
        C01053() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C01031();
        this.mShowListener = new C01042();
        this.mUpdateListener = new C01053();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0101R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0101R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0101R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0101R.id.action_bar_container);
        this.mSplitView = (ActionBarContainer) decor.findViewById(C0101R.id.split_action_bar);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0101R.styleable.ActionBar, C0101R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0101R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0101R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0101R.attr.actionBarWidgetTheme, outValue, true);
