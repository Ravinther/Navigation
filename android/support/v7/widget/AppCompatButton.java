...
public class AppCompatButton extends Button {
    ...
    public AppCompatButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0101R.attr.buttonStyle);
    }
    ...
    public AppCompatButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a2 = context.obtainStyledAttributes(attrs, C0101R.styleable.AppCompatTextView, defStyleAttr, 0);
        int ap = a2.getResourceId(C0101R.styleable.AppCompatTextView_android_textAppearance, -1);
        a2.recycle();
        if (ap != -1) {
            TypedArray appearance = context.obtainStyledAttributes(ap, C0101R.styleable.TextAppearance);
            if (appearance.hasValue(C0101R.styleable.TextAppearance_textAllCaps)) {
                setAllCaps(appearance.getBoolean(C0101R.styleable.TextAppearance_textAllCaps, false));
            }
            appearance.recycle();
        }
        a2 = context.obtainStyledAttributes(attrs, C0101R.styleable.AppCompatTextView, defStyleAttr, 0);
        if (a2.hasValue(C0101R.styleable.AppCompatTextView_textAllCaps)) {
            setAllCaps(a2.getBoolean(C0101R.styleable.AppCompatTextView_textAllCaps, false));
        }
        a2.recycle();
