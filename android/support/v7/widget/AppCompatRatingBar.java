...
public class AppCompatRatingBar extends RatingBar {
    ...
    public AppCompatRatingBar(Context context, AttributeSet attrs) {
        this(context, attrs, C0101R.attr.ratingBarStyle);
    }
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            frame.setLevel(PoiDetailFragment.MIN_STREET_VIEW_BYTES);
            newBg.addFrame(frame, background.getDuration(i));
        }
        newBg.setLevel(PoiDetailFragment.MIN_STREET_VIEW_BYTES);
        return newBg;
    }
