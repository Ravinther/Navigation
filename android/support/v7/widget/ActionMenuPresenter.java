...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu) {
            super(context, subMenu, null, false, C0101R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends TintImageView implements ActionMenuChildView {
        ...
        class C01301 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C01301(View x0, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0101R.attr.actionOverflowButtonStyle);
            this.mTempPts = new float[2];
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C01301(this, ActionMenuPresenter.this));
        }
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0101R.attr.actionOverflowMenuStyle);
            setGravity(8388613);
            setCallback(ActionMenuPresenter.this.mPopupPresenterCallback);
        }
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0101R.layout.abc_action_menu_layout, C0101R.layout.abc_action_menu_item_layout);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(C0101R.integer.abc_max_action_buttons);
        }
        if (this.mMenu != null) {
